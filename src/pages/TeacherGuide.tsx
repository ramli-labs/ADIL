...
export default function TeacherGuide() {
  ...
  return (
    <motion.section initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
      ...
      <div>
        <div className="font-mono text-[10px] tracking-[.22em] text-nara">MODE GURU</div>
        ...
        <div className="mt-3 flex flex-wrap gap-2 font-mono text-[9.5px] tracking-[.14em] text-haze">
      ...
      <div className="border border-gold/30 bg-gold/[.06] p-5">
        <div className="font-mono text-[9px] tracking-[.2em] text-gold">RINGKASAN PROFIL SISWA (SESI PERANGKAT INI)</div>
          ...
          return (
            <div key={c.id} className="border border-haze/20 p-5">
              <div className="flex flex-wrap items-baseline gap-3">
                ...
                <span className="font-mono text-[9.5px] text-haze">{l.duration} · {l.principle}</span>
                <span className="ml-auto font-mono text-[9.5px] text-cyan">{r ? `SKOR ${r.total}` : "BELUM DIKERJAKAN"}</span>
              </div>
              <div className="mt-4 grid gap-4 lg:grid-cols-3">
                <div>
                  <div className="font-mono text-[8.5px] tracking-[.18em] text-cyan">TUJUAN PEMBELAJARAN</div>
                ...
                <div>
                  <div className="font-mono text-[8.5px] tracking-[.18em] text-cyan">PERTANYAAN REFLEKSI</div>
                ...
                <div>
                  <div className="font-mono text-[8.5px] tracking-[.18em] text-cyan">AKTIVITAS KELAS</div>
                  <ul className="mt-2 space-y-1.5 text-[13px] leading-relaxed text-[#e3ebf3]">
