...
export default function AnalystProfileCard({ profile }: { profile: ProfileDef & { axes: AxisScores } }) {
  return (
    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
      ...
      <div className="font-mono text-[12px] tracking-[.22em] text-gold">PROFIL ANALIS</div>
      ...
      <div className="mt-5 flex flex-col gap-2.5">
        {(Object.keys(AXIS_LABEL) as (keyof AxisScores)[]).map((k) => (
          <div key={k}>
            <div className="flex justify-between font-mono text-[12px] tracking-[.14em] text-haze">
